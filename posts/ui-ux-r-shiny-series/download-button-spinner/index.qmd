...
As R Shiny applications become increasingly complex, it's important to provide users with a smooth and intuitive user experience. One way to do this is by adding a spinner to download buttons.

<img src="dnld-spinner.gif" alt="A gif showing what we will build today">

This is useful when you have a large dataset that takes a while to download. The spinner will give your users a visual cue that the download is in progress.

In this blog post, I'll show you how to add a spinner to a download button in Shiny using a module. 
...
Users can tell a lot about your application from the first few seconds of using it.
Your goal should always be to maximize user satisfaction.

Go out into the world and make your users happy.
